...
import chat1 from '../public/images/chat-author1.png';
...
const Header = ({ toggle, onClick }: HeaderProps) => {
  return (
    // <!-- Start Header -->
    <header className={`sherah-header ${toggle && 'sherah-close'}`}>
                    ...
                    <div className="sherah-header__group-two">
                      <div className="sherah-header__right">
                        ...
                        <div className="sherah-header__dropmenu sherah-header__dropmenu--messages">
                          ...
                          <span className="sherah-header__message--animate bg-greenLight">
                            <span className="bg-green block rounded-full w-2.5 h-2.5"></span>
                          </span>
                          <div className="sherah-dropdown-card sherah-dropdown-card__alarm">
                            <svg
                            ...
                            <h3 className="sherah-dropdown-card__title">Recent Message</h3>
                                ...
                                <div className="sherah-chatbox__inner">
                                  <div className="sherah-chatbox__author">
                                    <div className="sherah-chatbox__author-img">
                                      <Image src={chat1} width="152" height="36" alt="chat1" />
                              ...
                              <li>
                                <div className="sherah-chatbox__inner">
                                  ...
                                  <div className="sherah-chatbox__right">
                                    <span className="sherah-chatbox__unread">5</span>
                                  </div>
                                </div>
                              </li>
                              {/* <!-- End Single List --> */}
                            ...
                            <div className="flex justify-center">
                              <Link href="/" className="sherah-dropdown-card__sell-all">
                        ...
                        <div className="sherah-header__dropmenu">
                          ...
                          <span className="sherah-header__count bg-primary">4</span>
                          {/* <!-- sherah Alarm Hover --> */}
                          <div className="sherah-dropdown-card sherah-dropdown-card__alarm border-borderColor">
                            <svg
                              className="sherah-dropdown-arrow"
                              xmlns="http://www.w3.org/2000/svg"
                              width="43.488"
                            ...
                            <h3 className="sherah-dropdown-card__title border-borderColor">
                              Recent Notification
                            </h3>
                            {/* <!-- sherah Balance List --> */}
                                ...
                                <div className="sherah-paymentm__name">
                                  ...
                                  <div className="sherah-paymentm__content">
                                    <h4 className="sherah-notifications__title">
                                      You have an offer! <span>successfully done</span>
                                    </h4>
                        ...
                        {/* <!-- End Header Alarm --> */}
                        {/* <!-- Header Author --> */}
                        <div className="sherah-header__author flex items-start justify-center">
                          <div className="sherah-header__author-img">
                            <Image src={profile} width="152" height="36" alt="profile" />
                          </div>
                          <div className="sherah-header__author--info">
                            <h4 className="sherah-header__author--title  flex items-center flex-col">
                              Anthony <span className="sherah-header__author--text">USA</span>
                            </h4>
                            <svg
                              className="fill-[#1A1A1A] min-w-[10px] min-h-[7px]"
                              xmlns="http://www.w3.org/2000/svg"
                              width="10.621"
                              height="5.836"
                          ...
                          <div className="sherah-dropdown-card sherah-dropdown-card__profile border-borderColor">
                            <svg
                              className="sherah-dropdown-arrow"
                              xmlns="http://www.w3.org/2000/svg"
                              width="43.488"
                            ...
                            <h3 className="sherah-dropdown-card__title">My Profile</h3>
                            {/* <!-- sherah Balance List --> */}
                            <ul className="sherah-dropdown-card_list">
                              <li>
                                <div className="sherah-dropdown-card-info">
                                  <div className="sherah-dropdown-card__img bg-primary">
                                    <svg
                                      xmlns="http://www.w3.org/2000/svg"
                                      width="18.192"
                                      height="21.5"
